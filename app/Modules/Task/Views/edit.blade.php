        ...
        <form method="POST" action="{{ route($controller_name.'.update',$data->id) }}" class="form-validation" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Jobdesk</label>
                        <input type="text" name="jobdesk" class="form-control @error('jobdesk') is-invalid @enderror" value="{{ old('jobdesk') ?? ($data->jobdesk ?? null) }}" id="jobdesk" readonly>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="sla_duration" class="form-control @error('sla_duration') is-invalid @enderror" value="{{ old('sla_duration') ?? ($data->sla_duration ?? null) }}" id="sla_duration" readonly>
