        ...
        <div class="row">
            ...
            @if(session()->get('group_code') != 'EMP')
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Owner</label>
                        <select class="form-control form-select selectpicker @error('owner') is-invalid @enderror" name="owner" data-live-search="true" title="-- Select --" id="employee_id" disabled>
            ...
            @else
                <div class="col-md-6">
                    <div class="form-group">
                        <label>PIC</label>
                        <select class="form-control form-select selectpicker @error('pic') is-invalid @enderror" name="pic" data-live-search="true" title="-- Select --" id="employee_id" disabled>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <small class="form-text text-muted d-block">Jobdesk akan terisi jika sudah memilih Category, Job Type, and {{ session()->get('group_code') != 'EMP'? 'Owner' : 'PIC' }}.</small>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
