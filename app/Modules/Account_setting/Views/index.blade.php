...
<div class="container-fluid px-4">
    <h2 class="my-4">Account Setting</h2>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        @if($data->url_photo != '')
                            <img src="{{ $data->url_photo }}" class="object-fit-cover rounded-circle border d-flex align-items-center justify-content-center mb-3" style="width: 130px;height: 130px;">
                        @else
                            <div class="rounded-circle border d-flex align-items-center justify-content-center fs-1 mb-3" style="width: 130px;height: 130px;">
                                <i class="fa-solid fa-user" alt="Profile"></i>
                            </div>
                        @endif
                        <h3>{{ $data->name }}</h3>
                        <h4>{{ $data->group->name ?? null }}</h4>
                    </div>
                </div>
            </div>
            <div class="col-xl-8">
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade {{ !in_array(Session::get('type'),[1,2])? 'show active' : ''  }} profile-overview" id="profile-overview">
                                <h4 class="card-title mt-2">Detail Profil</h4>
                                <div class="row my-3">
